...
/*
        ...
        PUT ON HOLD BECAUSE SPOTIFY IS STUPID
...
cJSON* spotify_authorize()
{
    char* request = "GET /authorize?client_id=a5464f0b50b94b95a5f77b4b6a1f126c&response_type=code HTTP/1.1\r\nConnection: close\r\nHost: api.spotify.com\r\nAccept: application/json\r\n\r\n";
    SOCKET api_sock = get_connect_socket("accounts.spotify.com", "443");
...
cJSON* send_spotify_api_request(char* url, char* token)
{
    ...
    SOCKET api_sock = get_connect_socket("api.spotify.com", "443");
